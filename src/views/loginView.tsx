    ...
    return (
        <SafeAreaView style={styles.container} >
            <BlurView intensity={70} tint="dark" style={styles.blurContainer}>
                ...
                />
                <TextInput style={styles.textInputContainer} placeholder="Email" onChangeText={(text) => setEmail(text)} />
                <TextInput style={styles.textInputContainer} placeholder="Password" onChangeText={(text) => setPassword(text)} secureTextEntry />
